        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-3" id="adjustmentInventorySection">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Approved - Adjustment Inventory</h6>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="approvedInventoryTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <?php foreach ($combinedApprovedItems as $key => $item): ?>
                                    <tr>
                                        <td><?= $key + 1; ?></td>
            ...
            <!-- Approved Transfer Stock -->
            <div class="card shadow mb-3" id="transferStockSection">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Approved - Transfer Stock</h6>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="approvedTransferStockTable" width="100%"
                            cellspacing="0">
                            <thead>
                                <tr>
                                    <th>No</th>
                            ...
                            <tbody>
                                <?php foreach ($combinedApprovedItemsTransfer as $key => $item): ?>
                                    <tr>
                                        <td><?= $key + 1; ?></td>
                                        <td><?= $item['department'] ?? '' ?></td>
                                        <td><?= $item['pic'] ?? '' ?></td>
            ...
            <div class="card shadow mb-3" id="cancelLotSection">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Approved - Cancel Lot</h6>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="approvedCancelLotTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <?php foreach ($combinedApprovedItemsCancel as $key => $item): ?>
                                    <tr>
                                        <td><?= $key + 1; ?></td>
                                        <td><?= $item['department'] ?? '' ?></td>
                                        <td><?= $item['pic'] ?? '' ?></td>
