            ...
            <div class="card border-left-dark shadow-lg mb-3 pt-3">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-md-6 mb-3">
                            <div class="card border-left-primary shadow-lg h-100 w-100">
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <a href="<?= base_url('/inventory') ?>" class="btn btn-primary mt-3">Lihat Sekarang
                        ...
                        <?php if ($userRole !== 'MFG1' && $userRole !== 'MFG2'): ?>
                            <div class="col-xl-4 col-md-6 mb-3">
                                <div class="card border-left-success shadow-lg h-100 w-100">
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <a href="<?= base_url('/inventory/transfer') ?>" class="btn btn-success mt-3">Lihat
                                            Sekarang
                                            <i class="fa fa-arrow-right" aria-hidden="true"></i>
                                        </a>
                                    </div>
                        ...
                        <div class="col-xl-4 col-md-6 mb-3">
                            <div class="card border-left-danger shadow-lg h-100 w-100">
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <a href="<?= base_url('/inventory/cancelLot') ?>" class="btn btn-danger mt-3">Lihat
                                        Sekarang
                                        <i class="fa fa-arrow-right" aria-hidden="true"></i>
                                    </a>
                                </div>
                            ...
                            <div class="card border-left-warning shadow-lg h-100 w-100">
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <a href="<?= base_url('/dashboard/waiting_approved') ?>"
                                        class="btn btn-warning mt-3">Lihat Sekarang
                                        <i class="fa fa-arrow-right" aria-hidden="true"></i>
                                    </a>
                                </div>
                            </div>
